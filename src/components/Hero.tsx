          ...
          <div className=" w-[355.38px] mx-auto lg:w-full lg:w-full lg:h-[832px] ">
            ...
            <div className="lg:mt-[102px]">
              ...
              <div className="   mx-auto flex flex-row   items-center justify-center  lg:-mt-[750px] ">
                {/* Image */}
                <div className=" lg:w-[619px] lg:h-[126px] w-[273px] h-[64px] text-[42px] lg:text-[96px] text-white gap-0 font-playfair font-extrabold leading-[55.99px] lg:leading-[127.97px]  lg:ml-[120px]">
              ...
              {/* wishes */}
              <div className="h-[191px]  mt-2 font-merriweather font-semibold text-[20px] leading-[32px] text-white relative lg:text-[36px] lg:leading-[45.25px] lg:w-[895px] mx-auto lg:mt-[19px] lg:ml-[320px]">
            ...
            <div className="  w-full mt-9 mb-5 lg:ml-[130px]">

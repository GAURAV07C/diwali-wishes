...
const Blessing = () => {
  return (
    <div className=' w-full h-full bg-[#F2DDB4] overflow-hidden  relative z-10'>
      <div className='md:w-[1280px] md:h-[832px]  mx-auto flex flex-col md:flex-row justify-center items-center  gap-3 md:gap-0'>
        ...
        <div className='  w-10px    md:order-firsts mb-16'>
          <Image src='/mandapa.png' alt='mandap' width={390} height={341} >
          </Image>
          <Image src='/lakshmi-ganesh.png' alt='lakshmi-ganesh' width={351} height={301} className='-mt-[260px] w-[351px] h-[301px] mx-auto' />
